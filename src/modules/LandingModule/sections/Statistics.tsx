    ...
    <section className="relative z-20 mt-[-4rem] mb-10 flex w-full justify-center px-6">
      <div className="grid w-full max-w-6xl grid-cols-1 items-stretch gap-6 lg:grid-cols-3">
        ...
        <motion.div
          ...
          className="glass group relative flex h-full flex-col items-center justify-center overflow-hidden rounded-3xl border border-white/5 bg-black/40 p-8 text-center shadow-[0_20px_40px_-15px_theme('colors.purple.500/20')] backdrop-blur-xl transition-colors duration-500 hover:border-purple-500/30 lg:col-span-1"
        >
          {/* Subtle Background Gradient */}
          ...
          <div className="relative z-10 mb-6 flex h-16 w-16 items-center justify-center rounded-full border border-purple-500/20 bg-purple-500/10 transition-all duration-500 group-hover:scale-110 group-hover:bg-purple-500/20 group-hover:shadow-[0_0_20px_theme('colors.purple.500/30')]">
            <FaGraduationCap
              size={32}
          ...
          <div className="relative z-10 flex items-center gap-2 rounded-full border border-purple-500/20 bg-purple-500/10 px-5 py-2 shadow-[0_0_15px_theme('colors.purple.500/10')] transition-colors duration-300 group-hover:border-purple-400/50">
