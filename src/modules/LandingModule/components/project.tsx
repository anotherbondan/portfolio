      ...
      <div className="z-10 flex w-full flex-col justify-between py-1 lg:w-3/5 lg:py-2">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:gap-4 lg:mt-8">
          {data.projectUrl && (
            ...
            >
              <Button className="font-inter flex w-full items-center justify-center gap-2 rounded-xl bg-purple-600 px-4 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-300 hover:bg-purple-500 lg:px-6">
                View Project
