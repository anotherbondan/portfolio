...
for (const file of files) {
    ...
    if (newContent.includes("theme('colors.purple.")) {
        newContent = newContent.replace(/theme\('colors\.purple\./g, "theme('colors.primary.");
    }
    if (newContent.includes("rgba(147,51,234")) {
        newContent = newContent.replace(/rgba\(147,51,234,([0-9.]+)\)/g, "theme('colors.primary.600/$1')");
    }
